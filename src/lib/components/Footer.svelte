...
<footer class="relative z-10 w-full max-w-5xl mx-auto px-4 pb-12 sm:px-6 lg:px-8 text-center">
    ...
    <div class="space-y-5">
        ...
        <div class="flex flex-col items-center gap-3">
            <p class="text-cocoa-milk text-xs font-medium">
                Made with <span class="inline-block animate-pulse text-mochi-pink">💗</span> by
                <a href="https://github.com/tliesnham" target="_blank" rel="noopener noreferrer" class="text-mochi-pink hover:text-[#C2185B] hover:underline transition-colors">tliesnham</a>
            </p>
            <div class="flex items-center gap-4">
                <a href="https://github.com/getmochify" target="_blank" rel="noopener noreferrer" class="text-cocoa-milk hover:text-cocoa-deep transition-colors" aria-label="Mochify on GitHub">
                ...
                <a href="https://www.linkedin.com/company/mochify/" target="_blank" rel="noopener noreferrer" class="text-cocoa-milk hover:text-[#0077B5] transition-colors" aria-label="Mochify on LinkedIn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
