<script lang="ts">
	...
	function validateAndAddFiles(newFiles: File[]) {
		...
		// Effective mode: the current uploadMode, or inferred from the first valid file.
	...
	>
		...
		{#if showInfoTooltip}
			<div class="absolute bottom-14 right-3 z-50 w-64 rounded-2xl border border-white/60 bg-white/95 p-4 shadow-xl shadow-pink-100/40 backdrop-blur-md">
				...
				<p class="text-xs leading-relaxed text-[#4A2C2C]/75">JPG · PNG · WebP · AVIF · JPEG XL · HEIC · HEIF · HIF · SVG · PDF</p>
				<p class="mt-2 mb-1 text-[10px] font-black tracking-widest uppercase text-[#F06292]">PDF tools</p>
				<p class="text-xs leading-relaxed text-[#4A2C2C]/75">Rasterize pages to any image format, or split into individual page PDFs. Requires Growth plan.</p>
			</div>
