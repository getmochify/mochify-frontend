		...
		<div class="w-full max-w-sm">
			...
			>
				...
				<button
					...
					class="w-full flex items-center justify-center gap-2.5 py-3 rounded-2xl border border-[#875F42]/15 bg-white/80 text-[#4A2C2C] text-sm font-bold hover:bg-white hover:border-[#875F42]/30 transition-all cursor-pointer"
				>
