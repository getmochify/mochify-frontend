			...
			>
				...
				{:else}
					...
					<button
						...
						class="w-full flex items-center justify-center gap-2.5 py-3 rounded-2xl border border-[#D1D5DB] bg-white text-[#4A2C2C] text-sm font-bold shadow-sm hover:border-[#9CA3AF] hover:shadow-md transition-all cursor-pointer"
					>
