                ...
                <div class="space-y-4">
                    {#each [
                        ...
                        },
                        {
                            ...
                            a: "Background removal needs a free account, which includes 30 removals per month. Standard compression and conversion stay available without signing up."
                        },
                        {
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <a href="/solutions/ebay-image-converter" class="flex items-center gap-4 bg-white border border-pink-50 rounded-2xl px-5 py-4 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all no-underline group">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-[#875F42]">Listing-ready product images under the size limit</p>
                    </div>
                </a>
            </div>
        </section>
