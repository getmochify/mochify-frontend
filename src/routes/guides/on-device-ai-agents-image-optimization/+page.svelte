<script>
    ...
    const related = [
        ...
        { href: '/guides/privacy-image-optimization', title: 'Privacy & Image Optimization: A Comprehensive Guide', desc: 'GDPR, data minimization, and how to evaluate image optimization tools for regulated and NDA-sensitive workflows.' },
        ...
        { href: '/guides/compress-optimize-ai-generated-images', title: 'How to Compress and Optimize AI-Generated Images', desc: 'Why diffusion outputs are huge, which formats win, and how to automate the optimize-after-generation step in an agent pipeline.' },
        { href: '/guides/llm-image-token-costs', title: 'LLM Image Token Costs: How Many Tokens Does an Image Use?', desc: 'The per-model math behind image tokens, and why passing file paths instead of image bytes keeps agent context lean.' },
    ];
</script>
...
<article class="bg-white rounded-none md:rounded-3xl pt-6 px-6 pb-8 md:p-12 border-x md:border border-pink-50 shadow-sm relative overflow-hidden">
    ...
    <div class="space-y-8 text-lg text-[#6C3F31] leading-relaxed">
        ...
        <section id="token-costs" class="scroll-mt-24">
            ...
            <p>For on-device agents where context windows are tight and token throughput is measured in tens per second, this isn't an optimization. It's a prerequisite for running image workflows at any reasonable scale. For the per-model breakdown of how images are priced, see our guide to <a href="https://mochify.app/guides/llm-image-token-costs">LLM image token costs</a>.</p>
        </section>
                ...
                <ol class="space-y-6">
                    <li class="flex gap-4 items-start">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <pre class="bg-[#2D1B1B] text-pink-100 rounded-xl p-4 mb-3 overflow-x-auto font-mono text-sm leading-relaxed"><code>brew install getmochify/mochify/mochify</code></pre>
