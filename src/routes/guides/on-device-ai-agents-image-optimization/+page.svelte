...
<article class="bg-white rounded-none md:rounded-3xl pt-6 px-6 pb-8 md:p-12 border-x md:border border-pink-50 shadow-sm relative overflow-hidden">
    ...
    <div class="space-y-8 text-lg text-[#6C3F31] leading-relaxed">
        ...
        <section id="privacy-nuance" class="scroll-mt-24">
            ...
            <p>The important distinction is between the <em>agent runtime</em> being local and the <em>tools</em> being local. They are independent variables. A well-designed tool stack for regulated work audits both. For more on the privacy implications of different optimization paths, see our <a href="/guides/privacy-image-optimization" class="text-[#F06292] hover:text-[#D81B60] underline decoration-2 underline-offset-2 transition-colors">comprehensive guide to privacy and image optimization</a>.</p>
        </section>
        ...
        <section id="token-costs" class="scroll-mt-24">
            ...
            <p class="mb-4">First, raw token cost. <a href="https://platform.claude.com/docs/en/build-with-claude/vision" target="_blank" rel="noopener noreferrer" class="text-[#F06292] hover:text-[#D81B60] underline decoration-2 underline-offset-2 transition-colors">Claude's vision documentation</a> gives the formula: approximately <code class="bg-pink-50 text-[#D81B60] px-2 py-0.5 rounded font-mono text-sm">width * height / 750</code> tokens per image. A 1,000 x 1,000 pixel image (1 megapixel) costs roughly 1,334 tokens. A standard product photo at 3,000 x 2,000 runs to around 8,000 tokens. Pass ten images inline to start a batch job and you've consumed 80,000+ tokens before the agent has done any work.</p>
            ...
            <p class="mb-4">The established pattern, reflected in the <a href="https://modelcontextprotocol.info/docs/concepts/resources/" target="_blank" rel="noopener noreferrer" class="text-[#F06292] hover:text-[#D81B60] underline decoration-2 underline-offset-2 transition-colors">MCP resources specification</a>, is to pass file paths and metadata rather than binary data. The spec defines URI-based resource references (for example, <code class="bg-pink-50 text-[#D81B60] px-2 py-0.5 rounded font-mono text-sm">file:///home/user/project/image.jpg</code>) precisely for this: the tool server handles the file, the agent handles the reference. Anthropic's engineering write-up on <a href="https://www.anthropic.com/engineering/code-execution-with-mcp" target="_blank" rel="noopener noreferrer" class="text-[#F06292] hover:text-[#D81B60] underline decoration-2 underline-offset-2 transition-colors">MCP with code execution</a> frames this directly: MCP lets agents "use fewer tokens" by moving heavy data and compute into dedicated tool processes, with the model only seeing references and summaries.</p>
                ...
                <ol class="space-y-6">
                    <li class="flex gap-4 items-start">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="mb-0">On Linux, use the curl installer from <a href="https://github.com/getmochify/mochify-cli" target="_blank" rel="noopener noreferrer" class="text-[#F06292] hover:text-[#D81B60] underline decoration-2 underline-offset-2 transition-colors">github.com/getmochify/mochify-cli</a>, or <code class="bg-pink-50 text-[#D81B60] px-2 py-0.5 rounded font-mono text-sm">cargo install</code> from the repo directly.</p>
                        </div>
                    </li>
                    <li class="flex gap-4 items-start">
  ...
  "mcpServers": {
    "mochify": {
      ...
      "args": ["serve"]
            ...
            <p>MCP access is available on all Mochify tiers including Free (25 images/month). For heavier batch workloads, Seller ($7.99/month) gives you 300 images/month and 25-file batches. Details at <a href="/pricing" class="text-[#F06292] hover:text-[#D81B60] underline decoration-2 underline-offset-2 transition-colors">mochify.app/pricing</a>.</p>
        </section>
