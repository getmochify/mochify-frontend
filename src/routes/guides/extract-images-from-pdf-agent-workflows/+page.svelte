...
<article class="bg-white rounded-none md:rounded-3xl pt-6 px-6 pb-8 md:p-12 border-x md:border border-pink-50 shadow-sm relative overflow-hidden">
    ...
    <div class="space-y-8 text-lg text-[#6C3F31] leading-relaxed">
        ...
        <section id="how-to-extract-images-from-a-pdf">
            ...
            <p>A second rule of thumb worth internalising: rendering quality is not only about DPI. Anti-aliasing, font hinting, and color-space handling all affect whether small text and thin lines come out crisp or jagged, which is why a mature rendering engine matters more than a high number in the DPI field.</p>
        ...
        <section id="converting-pages-to-web-formats">
            ...
            <p>The "documents as web assets" framing is the useful mental shift here. A first-page thumbnail for a document-listing UI, a WebP preview embedded in a knowledge base, a cropped figure pulled from a report and served responsively: these are all just images now, and they belong in the same optimization pipeline you already run for photographs. Treating a PDF page as a web asset rather than a special document type is exactly how you keep one pipeline instead of two.</p>
            <p>The reverse direction comes up just as often in these pipelines: bundling a set of WebP images (screenshots, scanned pages, generated assets) back into a single document. Mochify's <a href="https://mochify.app/solutions/webp-to-pdf">WebP to PDF tool</a> handles that side of the workflow.</p>
        </section>
        ...
        <section id="quality-and-correctness-gotchas">
            ...
            <ul class="list-disc pl-6 space-y-2 my-4">
                ...
                <li><strong class="text-[#4A2C2C]">Color, transparency, and thin lines.</strong> High DPI alone does not guarantee quality. Anti-aliasing and color-space handling decide whether small text and fine lines render cleanly.</li>
            </ul>
        </section>
        ...
        <!-- CTA -->
        <GuideCTA
            heading="Wiring PDFs into an agent?"
            href="/"
