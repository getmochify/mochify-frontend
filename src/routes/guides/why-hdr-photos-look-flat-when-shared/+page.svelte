...
# X-Mochify-HDR: generated`;
    ...
    const related = [
        { title: "How to Make Any Photo Ultra HDR (Google Photos, Samsung, iPhone, Lightroom, or Online)", href: "/guides/how-to-make-any-photo-ultra-hdr", desc: "the how-to companion: convert an ordinary photo on every platform, and what conversion can and cannot do." },
