...
<svelte:head>
    <title>Mochify | Compress images, PDFs and video with plain language</title>
    <meta name="description" content="Say what you want in plain English and Mochify does it. Images and PDFs run anywhere the Rust binary does: a shell, a build script, or inside Claude via the local MCP server. Video converts in your browser and never uploads. Zero retention throughout.">

    <!-- CUTOVER: delete this line when this page becomes / -->
    <meta name="robots" content="noindex">

    <!-- canonical, og:image and twitter:image come from the root layout. -->

    <!-- Open Graph -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://mochify.app/" />
    <meta property="og:title" content="Mochify | Compress images, PDFs and video with plain language" />
    <meta property="og:description" content="One engine, six surfaces. Images and PDFs from the browser, your terminal, or your AI agent, with zero image bytes in the agent's context. Video converts in your browser and never uploads." />

    <!-- Twitter / X -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Mochify | Compress images, PDFs and video with plain language" />
    <meta name="twitter:description" content="One engine, six surfaces. Images and PDFs from the browser, your terminal, or your AI agent, with zero image bytes in the agent's context. Video converts in your browser and never uploads." />
        ...
        "@graph": [
            {
                ...
                "description": "Bulk image compressor for WebP, HEIC, JXL and AVIF. Try 3 images free without signing up. Free account unlocks 25 images per month. Native C++ engine, and files never touch disk.",
                ...
                "featureList": [
                    ...
                    "Natural-language Magic Flow prompts",
                    "Smart square-crop for marketplace listings",
                    "Local MCP server and REST API access",
            ...
            },
            {
                ...
                "mainEntity": [
                    ...
                    },
                    {
                        ...
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "Yes. The REST API is available at api.mochify.app. Without an API key, 3 images per month are available (IP-based). Create a free account for 25 images per month. Seller provides 300 and Pro provides 1,200, both including a Bearer-token key for higher-volume automation."
                        }
                    },
                    {
                        "@type": "Question",
                        ...
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "Yes. Install the Rust binary with 'brew install mochify'. The same binary runs as a direct CLI and as a local MCP server for Claude Desktop, Cursor, and any stdio MCP client. Because the binary opens files on your own disk, only file paths and result metadata cross the agent context, never image bytes."
                        }
                    },
                    {
                        "@type": "Question",
