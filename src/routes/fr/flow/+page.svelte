...
<svelte:head>
	...
	<!-- hreflang: one set across all three languages, the same four lines on each
	     Flow page, with English as x-default. Serving is by URL only; there is no
	     redirect by IP or Accept-Language anywhere, because that hides this page
	     from a crawler in the US. -->
